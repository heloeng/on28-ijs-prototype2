...
*/
  ...
  //!SEGUNDA FORMA DE SOBRESCREVER MÉTODO: vai UTILIZAR 
//!O MÉTODO DA CLASSE MÃE E ACRESCENTAR ALGO
//!VAI PRIORIZAR O MÉTODO DA CLASSE FILHA
//super para sobrescrever outros métodos pode ser em qualquer lugar
///não precisa ser chamado primeiro como na sobrescrita de construtor
    speak() {
   
      //acrescentei esse console
      console.log(`A pessoa que está falando é uma usuária.`);// retorna: A pessoa que está falando é uma usuária.
      super.speak(); //retorna: A pessoa de nome Luara está falando
    }
    }
